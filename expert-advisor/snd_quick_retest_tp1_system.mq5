//+------------------------------------------------------------------+
//|                                             SND_Quick_Retest_TP1_System.mq5|
//|                                  Copyright 2026, User            |
//+------------------------------------------------------------------+
#property strict
...
void PlaceBuyNow() { 
   ...
   if(trade.Buy(lot, _Symbol, 0, sl, tp1, "BuyNow"))
      Print("Buy order executed: Lot=", lot, ", SL=", sl, ", TP=", tp1);
   else
...
void PlaceSellNow() { 
   ...
   if(trade.Sell(lot, _Symbol, 0, sl, tp1, "SellNow"))
      Print("Sell order executed: Lot=", lot, ", SL=", sl, ", TP=", tp1);
   else
