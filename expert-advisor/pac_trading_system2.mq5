...
input ulong InpMagicNumber = 22222; // Magic Number (Harus beda tiap chart)
...
{ 
   ...
   PREF = "PAC_" + IntegerToString(InpMagicNumber) + "_";
   ZONE_PREF = "PAC_Z_" + IntegerToString(InpMagicNumber) + "_";
...
void PlaceSellLimit()
{
   ...
   double tp = GetInputValue("Sell_TP");
...
void CheckCutLoss()
{
   ...
   if(buyFloorTouched && closePrice > bEntry) {
      ClosePositionsByType(POSITION_TYPE_BUY, InpMagicNumber);
   ...
   if(sellCeilingTouched && closePrice < sEntry) {
      ClosePositionsByType(POSITION_TYPE_SELL, InpMagicNumber);
...
void CreateDashboard() {
   ...
   int titleCenterX = (PANEL_W / 2) + 10 - 40; 
   CreateLabel("Title", titleCenterX, HEADER_Y + 2, "Pivot and Control", clrWhite); 
   ...
   CreateLabel("LblLot", sellColumnX, UI_Y+12, "Lot/Layer:", clrOrange);
   CreateEdit("InpLot", sellColumnX + 130, UI_Y+18, editW, 25, "0.01");
   
   CreateButton("BtnDraw", 20, UI_Y+80, 180, 30, "Draw Line", clrPurple, clrWhite);
   CreateButton("BtnScanSD", sellColumnX, UI_Y+80, 180, 30, "Scan S&D", clrDarkGreen, clrWhite);
   ...
   for(int i=0; i<6; i++) {
      ...
      CreateEdit("Sell_"+sLabels[i], sellColumnX + 130, editY, editW, 25, "0.00");
   }
   
   CreateButton("BtnBuyL", 20, UI_Y + 370, 200, 30, "Buy Limit", clrBlue, clrWhite);
   CreateButton("BtnSellL", sellColumnX, UI_Y + 370, 200, 30, "Sell Limit", clrOrange, clrWhite);
   
   CreateButton("DelBuy", 20, UI_Y + 410, 200, 30, "Del Buy", clrBlue, clrWhite);
   CreateButton("DelSell", sellColumnX, UI_Y + 410, 200, 30, "Del Sell", clrBrown, clrWhite);
   
   CreateButton("ClosePos", 20, UI_Y + 450, PANEL_W-40, 30, "Close Positions", clrDarkRed, clrWhite);
   CreateButton("CloseOrd", 20, UI_Y + 490, PANEL_W-40, 30, "Close All Orders", clrMaroon, clrWhite);
   CreateButton("Reset", 20, UI_Y + 530, PANEL_W-40, 30, "ResetLines & Calc", clrGray, clrBlack);
   CreateButton("BuyNow", 20, UI_Y + 570, 200, 30, "Buy Now", clrDodgerBlue, clrWhite);
   CreateButton("SellNow", sellColumnX, UI_Y + 570, 200, 30, "Sell Now", clrOrangeRed, clrWhite);
