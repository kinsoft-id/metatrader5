...
void CreateDashboard() {
   ...
   CreateLabel("Title", (PANEL_W / 2) + 20, HEADER_Y + 20, "SND Fibo Candle", clrWhite);
   ...
   CreateButton("BtnLotMode", 270, UI_Y+14, 90, 25, "Lot", clrDarkSlateGray, clrOrange);
   CreateEdit("InpLot", 370, UI_Y+14, 110, 25, "1.00");
   CreateCalcLotLabel();
   ApplyLotModeUI();

   CreateLabel("LB_Risk", 20, UI_Y+62, "Risk $", clrOrange);
   CreateEdit("Buy_Risk", 130, UI_Y+50, 110, 25, "0.00");
   CreateLabel("LS_Risk", 270, UI_Y+62, "Risk $", clrOrange);
   CreateEdit("Sell_Risk", 370, UI_Y+50, 110, 25, "0.00");

   CreateButton("BtnScanSD", 20, UI_Y+88, 460, 30, "Scan S&D", clrDarkGreen, clrWhite);

   CreateButton("BtnScanFibo", 20, UI_Y + 128, 150, 30, "Scan Fibo", clrTeal, clrWhite);
   ...
   CreateButton("SellNow", 270, UI_Y + 404, 200, 30, "Sell Now", clrOrangeRed, clrWhite);
   CreateButton("GetNews", 20, UI_Y + 444, 200, 30, "Get News", clrGray, clrBlack);
   CreateButton("Reset", 270, UI_Y + 444, 200, 30, "Reset", clrGray, clrBlack);
...
void CreateFiboLevelToggles()
{
   ...
   for(int lv = 1; lv <= 5; lv++)
   {
      ...
      CreateButton(name, xs[lv - 1], UI_Y + 166, 88, 28,
