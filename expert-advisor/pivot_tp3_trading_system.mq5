...
{ 
   ...
   PREF = "PIVOT_TP3_" + IntegerToString(InpMagicNumber) + "_";
   ZONE_PREF = "PIVOT_TP3_Z_" + IntegerToString(InpMagicNumber) + "_";
...
void PlaceBuyLimit()
{
   ...
   double tp = GetInputValue("Sell_Ceiling");
...
void PlaceSellLimit()
{
   ...
   double tp = GetInputValue("Buy_Floor");
...
void CreateDashboard() {
   ...
   CreateLabel("Title", titleCenterX, HEADER_Y + 2, "Pivot in Control TP3", clrWhite); 
