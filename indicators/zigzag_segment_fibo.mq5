...
input ENUM_HL_TF       InpHLTimeframe = HL_TF_D1;      // Timeframe
...
int        g_h1Shown = 0;
ENUM_TIMEFRAMES g_hlTf = PERIOD_D1;
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "ZigZag Segment Fibo (" + HLTagFromTf(g_hlTf) + ")");
